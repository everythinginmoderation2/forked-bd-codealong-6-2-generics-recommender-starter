package com.amazon.ata.generics.classroom.recommender.movie;

import com.amazon.ata.generics.classroom.recommender.MostRecentlyUsed;
import com.amazon.ata.generics.classroom.recommender.ReadOnlyDao;
...
class PrimeVideoRecommenderWatchTest {
    private File kidsMovies = new File("./resources/generics/classroom/recommender/kidsmovies.csv");
